...
| **Promesse 1** | Ce que l'on voit à l'écran est **exactement** ce qui s'imprime : mêmes couleurs, même pagination, aucun bloc coupé. |
...
46 symboles `//` · 150 icônes en 7 familles · 35 fonctions de tableur · 26 fiches de Tuto ·
54 questions de FAQ · 414 fonctions JavaScript · 270 vérifications automatiques.
...
4. **Aucun bloc coupé par une page**, sauf le QCM qui se coupe **entre deux questions**. Une
   question reste toujours avec ses réponses et son commentaire.
...
## 9. Batterie de tests — 248 vérifications
...
for t in catalog_test exc_audit ex_test qcm_test qcm2_test regress_test \
         ...
         offline_test tablet_test idb_test print_audit; do
...
*Dossier établi le 25 septembre 2026, révisé après le passage au stockage large. À joindre à toute nouvelle conversation, avec
