...
tableur · 27 fiches de Tuto · 60 questions de FAQ · 414 fonctions JavaScript ·
**354 vérifications automatiques**.
...
## 9. Batterie de tests — 354 vérifications
...
for t in catalog_test exc_audit ex_test qcm_test qcm2_test regress_test \
         ...
         tablet_test idb_test leak_test fmt_test comp_test pg_test print_audit; do
...
*Dossier établi le 25 septembre 2026, révisé après les pastilles de compétences et la
reprise de la pagination. À joindre à toute nouvelle conversation, avec
